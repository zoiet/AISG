...
UCLU-1: Unsupervised Learning in Python
...
Measuring clustering quality
    - Using only samples and their luster labels
    - A good clustering has tight clusters
    - Samples in each cluster brunched together
Inertia measures clustering quality
    - Measures how spread out the clusters are (lower is better)
    - Distance from each sample to centroid of its clusterAfter fit(), available as attribute _inertia_
...
KMeans -> Use fit() / predict()

Use Pipelines to combine multiple steps (StandardScaler and KMeans)
#########################################################################
...
# Hierarchical clustering
    ...
    - With 5 data samples, there would be 4 merge operations; 6 data samples, 5 merge

SciPy linkage() function performs hierarchical clustering on an array of samples
dendrogram() is used to visualize the result
#########################################################################
...
# Use fcluster to extract labels: labels with max height 6
...
Dimension reduction
    ...
    - Remove less-informative "noise" features which will affect prediction task

Principal Component Analysis [PCA]
    - Fundamental dimension reduction technique
    - First step "decorrelation"
    - Second step reduce noise
